        ...
        <div className='mb-2 flex flex-col gap-2 sm:flex-row sm:gap-4'>
            <Box sx={{ flex: 1 }}>
                <div className='flex justify-between items-center font-1'>
                    <Typography style={{ color: errors.firstName ? 'red' : 'inherit' }}>
                        First Name *
                    </Typography>
                </div>
                <TextField
                    ...
                    InputProps={{
                        ...
                        sx: { height: '2.5rem', width: '100%', border: errors.firstName ? '.1px solid red' : 'inherit' }
                    }}
                    name="firstName"
            ...
            <Box sx={{ flex: 1 }}>
                <div className='flex justify-between items-center font-1'>
                    <Typography style={{ color: errors.lastName ? 'red' : 'inherit' }}>
                        Last Name *
                    </Typography>
                </div>
                <TextField
                    ...
                    InputProps={{
                        ...
                        sx: { height: '2.5rem', border: errors.lastName ? '.1px solid red' : 'inherit' }
                    }}
                    name="lastName"
